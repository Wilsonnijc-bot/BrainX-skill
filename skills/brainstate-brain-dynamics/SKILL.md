---
name: brainstate-brain-dynamics
...
• treating BrainState brain-dynamics as a full BrainCell skill -> branch to BrainCell when morphology, mechanisms, or cell-specific APIs are the actual task.
