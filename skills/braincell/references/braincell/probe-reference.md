...
## Second-level diagnostic route

Open `references/diagnostics/common-failures-index.md` only after this child identifies a recurring probe, trace-key, locset, or runtime-state failure.
