...
This nested child is never a first-hop skill, training-parent, or index route. The dynamics parent must establish the task first.
...
- For generic optimizer/loss/metrics: `skills/brainstate/references/deeplearning-training/supervised-training-workflows.md`.
- For time loops/branches: `skills/brainstate/SKILL.md` and `references/brainstate/brainstate-control-flow-patterns.md`.
- For stochastic data/dropout/random spikes: `references/brainstate-randomness-reproducibility/randomness-and-reproducibility.md`.
