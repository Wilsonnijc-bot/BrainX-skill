...
* Open `references/braincell/braincell-custom-ion-channel-authoring.md` only when the built-in ion/channel families do not cover the requested biological mechanism.
