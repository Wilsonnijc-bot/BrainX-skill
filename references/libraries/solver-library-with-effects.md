...
| Composite / cable | `cn_exp_euler`, `cn_rk4`, `splitting`, `staggered`, `dhs_voltage` | Designed for multicompartment/cable coupling; route geometry tasks to `braincell-multicompartment`. |
