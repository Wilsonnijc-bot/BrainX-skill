# BrainState Dynamics Reference Hub

## Purpose

BrainState dynamics is a specialized `Module` pattern for time-evolving systems. Use this reference hub when a primary skill has already established that the task is about time evolution rather than ordinary static module composition.

## Use when

Open this hub for `Dynamics`, `update()`, time-evolving state, LIF/SNN populations, delays, hooks, event-driven spike communication, trajectory simulation, or neural population workflows.
